                    ...
                    {state ?
                        <div className="card p-5 w-50 m-auto">
                            <form onSubmit={submitFormData}>
                                <p>We sent an email to {email.email}
                                    <br />
                                    with a code to Re-Set your account password .
                                    <br/>
                                    If you receive the code click <Link to="/ForgetPassword" className='text-info'>Here..</Link>
                                </p>

                                <p className='mt-2'> Re-send code after {time} seconds remaining</p>
                                <button id='btn'
